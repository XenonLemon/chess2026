...
public class Square extends JComponent {
    ...
    private ElephantPiece occupyingPiece;
    ...
    public ElephantPiece getOccupyingPiece() {
    ...
    public void put(ElephantPiece p) {
        this.occupyingPiece = p;
    }
    
    public ElephantPiece removePiece() {
        ElephantPiece p = this.occupyingPiece;
